...
#----------------------------------------------------------------------------------------------#
    ...
    def setupWindows(self):
        ...
        self.windows = [self.nSOTChar, self.FieldControl, self.TempControl]
        ...
        self.Scripting = Scripting.Window(self.reactor, None, None, None, self.nSOTChar, self.FieldControl, self.TempControl,
            None, None, None)
