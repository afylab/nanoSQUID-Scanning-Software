...
class Window(QtGui.QMainWindow, ScanControlWindowUI.Ui_MainWindow):
    ...
    def toggleFrameLock(self):
        if self.FrameLocked == True:
            ...
            "image:url(:/nSOTScanner/unlock.png);background: black;}")
            self.FrameLocked = False
        else:
            self.push_FrameLock.setStyleSheet("#push_FrameLock{"+
            "image:url(:/nSOTScanner/lock.png);background: black;}")
            self.FrameLocked = True
